...
async function getArticles() {
  try {
    ...
    result.data.sort((a, b) => a.updateDate == null ? new Date(b.createdDate) - new Date(a.createdDate) : new Date(b.updateDate) - new Date(a.updateDate))
    result.data.sort((a, b) => a.id_section - b.id_section) // ordenado por id_section
    return result.data
  } catch (error) {
